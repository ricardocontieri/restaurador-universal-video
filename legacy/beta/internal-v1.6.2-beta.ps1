...
function Mux-Final {
    ...
    Write-Host `
        "       Vídeo é autoritativo no mux; sem -shortest para não perder o último frame quando o AAC termina antes." `
        -ForegroundColor DarkCyan
...
Write-Host "============================================================" `
    -ForegroundColor Cyan
Write-Host " RESTAURADOR UNIVERSAL DE VIDEOS V1.6.2 - SMART DUAL GPU / SHORT-FILE + LAST-FRAME FIX / 1080P / STAB / PILLAR BLUR" `
    -ForegroundColor Cyan
Write-Host "============================================================" `
    -ForegroundColor Cyan
Write-Host ""
